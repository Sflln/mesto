...
let popupwindow = document.querySelector('.popup_type-edit');
...
let popupCards = document.querySelector('.popup_type-cards'); //Попап с добавлением новой карточки
...
let popupImg = document.querySelector('.popup_type-img');
